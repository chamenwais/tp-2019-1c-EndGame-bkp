...
int colocar_value_en_MP(char *, double, uint16_t,char *);
int insertar_value_modificado_en_MP(char *, double, uint16_t,char *);
void actualizar_value_modificado_en_MP(char *, double, uint16_t,char *);
...
void insertar_registro_en_marco(double , uint16_t , char *, int );
...
int almacenar_valor(char*, double, uint16_t, char*, int);
int obtener_1er_byte_marco_en_MP(int);
double * obtener_timestamp_desde_marco_en_MP(int);
